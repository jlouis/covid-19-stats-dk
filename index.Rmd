...
data <- read_data(file, col_types=cols('Kommune' = col_double(), # This will need fixing later
                                       ...
                                       'Bekræftede tilfælde' = col_double(),
                                       'Incidens' = col_double(),
                                       'Bekræftede tilfælde de seneste 7 dage' = col_double(),
...
data <- data %>% rename(lau1 = 'Kommune',
                        ...
                        cases = 'Bekræftede tilfælde de seneste 7 dage',
...
plot_regions(p, "Regional split of cases, DK",
                "Copenhagen-general area (Hovedstaden) contributes most of the noise")
```

We can also visualize regional new hospitalizations:
...
p + geom_point(aes(color=region), size=.5) +
    ...
    labs(title = "Regional split of Hospitalizations, DK",
         subtitle = "Copenhagen-general area (Hovedstaden) contributes most of the noise",
         caption = "Source: ssi.dk",
         x = "Date",
         y = "Detected Cases")
